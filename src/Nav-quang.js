export default function Bnhd(){
    return(
        <nav className="section nav">
            <div className="container">
                <div className="top-left-3">
                    <ul>
                        <li><a className="top-left-3-1" href="https://tokyogateaux.vn/">HOME</a></li>
                        <li className="top-left-3-2">/</li>
                        <li><a className="top-left-3-1" href="https://tokyogateaux.vn/banh-sinh-nhat/banh-sinh-nhat/">BÁNH
                            SINH NHẬT</a></li>
                        <li className="top-left-3-2">/</li>
                        <li><span className="top-left-3-1">BÁNH SINH NHẬT HIỆN ĐẠI</span></li>
                    </ul>
                </div>
